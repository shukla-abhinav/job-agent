...
function resumeToMarkdown(resume: ResumeResult, job: JobListing): string {
  ...
  lines.push('---');
  lines.push('');
  lines.push('*Generated by JobSense — paste this Markdown or JSON into any LLM (ChatGPT, Claude, Gemini) to generate a beautifully formatted resume in any style, language, or template.*');
  return lines.join('\n');
}
        ...
        <div className="flex-1 overflow-y-auto px-8 py-6 space-y-8">
          ...
          <section className="border-t border-slate-100 pt-8">
            ...
            <div className="flex items-start justify-between mb-3 flex-wrap gap-3">
              <div>
                <h3 className="text-sm font-semibold text-slate-500 uppercase tracking-wider">Resume Update Suggestions</h3>
                <p className="text-xs text-slate-400 mt-0.5">Get resume update suggestions tailored to this job.</p>
              </div>
